...
import { EacWidget } from '../../base-items/widgets/EacWidget/EacWidget';
...
export const SortableEac: React.FC<Props> = ({ id, editMode, isOverlay = false, config, onDelete, onEdit, onDuplicate }) => {
