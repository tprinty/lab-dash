...
import { CameraWidget } from '../../base-items/widgets/CameraWidget/CameraWidget';
...
export const SortableCamera: React.FC<Props> = ({ id, editMode, isOverlay = false, config, onDelete, onEdit, onDuplicate }) => {
