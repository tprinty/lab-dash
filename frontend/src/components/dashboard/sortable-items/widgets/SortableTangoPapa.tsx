...
import { TangoPapaWidget } from '../../base-items/widgets/TangoPapaWidget/TangoPapaWidget';
...
export const SortableTangoPapa: React.FC<Props> = ({ id, editMode, isOverlay = false, config, onDelete, onEdit, onDuplicate }) => {
